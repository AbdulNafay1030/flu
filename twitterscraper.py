...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        # Access credentials
        consumer_key = os.environ.get("iKoFucemlBagk5rHc0RuJBOCP")
        consumer_secret = os.environ.get("aKh7NY9htRVd3cvzEHBONeiXDRthTYcP4TZM3v32YysBrsLAgz")
        access_token = os.environ.get("1612355890514132992-TiWoAxWlQ9PAFclyMHbGQSUNqSDIhy")
        access_token_secret = os.environ.get("j4Sir7jgV5tsPMcxO9nndpwkhh2UMyzzNpsxz6SRrCO3u")
